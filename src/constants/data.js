...
export const FAQS = [
  {
    ...
    ANSWER: "I'm busy working on the actual site. It is expected to go live within the next 69 years.",
  },
  {
    QUESTION: "What did you use for this site?",
    ANSWER: "For this one, I just used Astro & some good old CSS for styles. Plain & simple.",
  },
  {
    QUESTION: "What are you using for the actual site?",
    ANSWER: "I'm using Next.js & TypeScript along with TailwindCSS for styles & GSAP for animations.",
  },
  {
